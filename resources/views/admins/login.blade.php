    ...
    <section class="bg-gray-50 dark:bg-gray-900 m-4 rounded-lg">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
            <div class="flex flex-col justify-center">
                <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Hola Administrador!!!</h1>
                <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
                    Ingresa tus credenciales de root.
                </p>
            </div>
            <div>
                <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                    ...
                    <form class="mt-8 space-y-6" action="{{route('admins.login')}}" method="POST">
                        @csrf
                        <div>
                        ...
                        <div class="flex items-start">
                            ...
                            <a href="{{url('/')}}" class="ms-auto text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Eres empleado?</a>
                        </div>
